...
import {closePopup} from "../../content/content.tsx";
...
const Offer = () => {
    ...
    return (
        <div className="flex justify-center items-center w-full h-full py-6  px-4">
            <div
                className="p-5 bg-white shadow-lg rounded-lg w-full sm:w-[90%] md:w-[60%] lg:w-[50%] xl:w-[35vw] max-w-[600px] min-w-[300px] h-[32vh] border border-gray-300 mx-auto flex flex-col items-center relative"
            >
                <button
                    onClick={closePopup}
                    className="absolute top-3  right-5  rounded-full hover:bg-gray-300 hover:text-gray-800 focus:outline-none"
                    aria-label="Close"
                >
                    <img
                        className={"h-6 w-6 text-gray-800"}
                        src="https://static.thenounproject.com/png/953232-200.png" alt="close"/>
                </button>
            ...
            {openToggle && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    <div
                        className="w-[90vw] sm:w-[70vw] md:w-[50vw] lg:w-[40vw] xl:w-[55vw] rounded-lg p-6 transform transition-all duration-300 ease-in-out ">
                        <Login/>
